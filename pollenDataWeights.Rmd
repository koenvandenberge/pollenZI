...
It is unclear which model provides the best fit to the data.

Let's look at the SHISA2 gene, which was identified as a gene where results are very different because of accounting for zero inflation.
...
How many fold-changes are switching signs? 
